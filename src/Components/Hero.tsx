...
const slides = [
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/hero/herosofa.png", 
    lampImage: "/hero/herobulb.png", 
  },
  {
  ...
  return (
    <section className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center">
        ...
        <Link href="#">
          <span className="inline-block bg-pink-500 text-white text-sm font-medium py-3 px-6 rounded-md mt-6 hover:bg-pink-600 transition-all duration-300 w-1/3 text-center">
            {current.buttonText}
          </span>
        </Link>
      </div>
      ...
      <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 flex space-x-2">
        {slides.map((_, index) => (
          <button
            ...
            aria-label={`Slide ${index + 1}`} // Added for accessibility
            title={`Go to slide ${index + 1}`} // Added title attribute
      ...
      <button
        ...
        title="Previous Slide" // Added title attribute
      ...
      <button
        ...
        title="Next Slide" // Added title attribute
